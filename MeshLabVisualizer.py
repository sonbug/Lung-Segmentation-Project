...
imgs_after_rg = np.load(working_path + "/trachea_to_model_%d.npy" % (id))
np_edge = imgs_after_rg
bronchioles_after_rg = imgs_after_rg
tumor_after_rg = imgs_after_rg
...
imgs_after_rg = np.load(working_path + "/trachea_to_model_%d.npy" % (id))
np_edge = np.load(working_path + "/Segmentation Project/" + "justedge_%d.npy" % (id))
bronchioles_after_rg = np.load(working_path + "/Segmentation Project/" + "bronchioles_after_rg_%d.npy" % (id))
tumor_after_rg = np.load(working_path + "/Segmentation Project/" + "Tumor_in_lungs_%d.npy" % (id))
